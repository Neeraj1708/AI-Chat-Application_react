...
function App() {
  ...
  const askQuestion = async () => {
    ...
    setLoader(true);
    // localStorage.setItem('histoy', [question])
  ...
  return (
    ...
    <div className='grid grid-cols-5 h-screen text-center'>
      ...
      <div className='col-span-4 p-10'>
          <h1 className='text-4xl bg-clip-text text-transparent bg-gradient-to-r from-red-700 to-violet-700 '
          >Hey there! What can I help you with?</h1>
        ...
        <div ref={scrollToAns} className='container h-125 overflow-scroll'>
          <div className='dark:text-zinc-300 text text-zinc-800'>
            <ul>
              {
        ...
        border border-zinc-700 flex h-15'>
          <input type="text" value={question}
            onKeyDown={isEnter}
            onChange={(e) => setQuestion(e.target.value)} className='w-full h-full p-3 outline-none'
